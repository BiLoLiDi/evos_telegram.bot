...
class Database:
    ...
    def check_user_order_exists(self, product_id, quantity, product_type):
        ...
        """
        return self.execute(sql=sql, parameters=(product_id, quantity, product_type), fetchone=True)
